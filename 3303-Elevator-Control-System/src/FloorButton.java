...
/**
 * FloorButton class receives information of passenger's choice, up, or down.
 * There are two buttons for each floor.
 * 
...
public class FloorButton extends Floor {
	...
	/**
	 * This default constructor is for creating a FloorButton object on floor
	 * floorNumber, Sets both directions to false, making the FloorButton initially
	 * inactive.
	 * 
	...
	/**
	 * This constructor creates a floorButton object, giving the use an option to
	 * set the initial direction of the button to either up, down, or both in order
	 * to test for errors.
	 * 
	 * @param floorNumber The floor on which the buttons are on.
	...
	/**
	 * Allows the user to check if either light is active, need to check for errors
	 * in later iterations.
	 * 
