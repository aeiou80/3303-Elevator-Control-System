/*
 * FloorLamp class receives information of passenger's choice,
 * up, or down and light the correct lamp. There are two lamps 
 * for each floor.
 */
public class FloorLamp extends Floor {
	...
	/**
	 * This constructor creates an object FloorLamp on floor floorNumber, allowing the user to set the initial
	 * direction of the light to either up, down, or both to check for errors. 
	 * @param floorNumber The floor the lamp is on.
